...
<body>
    <div class="wrapper">
        <div class="sidebar" data-color="white" data-image="../assets/img/sidebar.jpg">
            <!--
                Tip 1: You can change the color of the sidebar using: data-color="white | purple | blue | green | orange | red"

                Tip 2: you can also add an image using data-image tag
            -->
            <div class="logo">
                <a href="https://www.asmisurabaya.ac.id/" class="simple-text">
